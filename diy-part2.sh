...
dirs="k3screenctrl,k3screenctrl_build,luci-app-k3screenctrl,luci-app-autotimeset,luci-app-poweroff,luci-app-syncdial,luci-app-smartdns,smartdns,luci-app-eqos,luci-app-sfe"                                                                                                
OLD_IFS="$IFS"
IFS=","
array=($dirs)
for i in ${array[@]}
